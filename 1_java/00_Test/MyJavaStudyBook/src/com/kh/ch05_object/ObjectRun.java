...
public class ObjectRun {
	...
	public static void main(String[] args) {
		/*
		 * 	*객체 : 현실 세계에 독립적으로 존재하는 것들(목적/가치/의미가 있는 유형/무형/개녕 등)
		 * 
		 *	*객체지향 프로그램 : 현실셰계의 객체들간의 상호작용을 프로그램을통해 	
		 *								가상세계로 구현하는 과정(플그램밍)
		 *	=>프로그램 상에 필요한 객체들을 만들기 위해 "클래스"라는 들을 먼저 만들어야 함
		 *	*클래스 : 객체들의 숙성(정보)들을 담고 있는틀
		 *	
		 *	- 추상화 과정 : 대상객체에 대하여 정리하는 작업 
		 *	[1] 프로그램에서 필요한 대상 객체 선정 
		 *	[2]	객체들이 가지고 있는 공통적인 속성, 기능들을 모두 추출
		 *	[3]	추출된 내요들을 가지고 구현할 프로그램에 "목적"에 맞게 필요한 속성. 기능을 추려냄 갓
		 ...
		 * 				"데이터에 간접적으로" 처리하는 메소드를 클래스 내부에 직접하는 것
		 * 							-->값을 대입/반환
		 * [1] 정보 은닉 : private 제한자 사용
		 * [2] getter/setter 메소드 : private 으로 제한된 필드(변수)에 간접적으로 접근할수 있도록
		 * 					기능을 제공하는 메소드
		...
		Animal animal2 = new Animal("초록이", 5,'M', "민욱님", "고양이");
