...
--  * 숫자타입으로 변경
-- ALTER TABLE DEPT_TABLE MODIFY DEPT_ID NUMBER; --> 형식 오류 발생! (기존: 문자타입, 변경: 숫자타입) X
...
-- ALTER TABLE EMP_TABLE MODIFY SALARY VARCHAR2(50); --> 형식 오류 발생!
...
/*
    ...
    * CHECK (특정 값들만 저장하고자 할때 사용하는 제약조건, NULL값 가능) : ALTER TABLE 테이블명 ADD CHECK(컬럼에 대한 조건식)
...
ALTER TABLE DEPT_TABLE RENAME CONSTRAINT SYS_C008548 TO DT_DEPTID_NN;
