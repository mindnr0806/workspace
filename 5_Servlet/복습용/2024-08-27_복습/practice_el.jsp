		...
		<div class="row">
			...
			<div class="col">
				<div class="input-group">
			  		...
			  		<input type="text" class="form-control focus-ring focus-ring-danger" value="" readonly>
				</div>
			</div>			
		</div>
		...
		<div class="row">
			...
			<div class="col">
				...
				<div class="input-group">
			  		...
			  		<input type="text" class="form-control focus-ring focus-ring-success" value="" readonly>
				</div>
